    ...
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            if (accessKey!= null) {
                transformedAccessKey = ((String) evaluateAndTransform(_muleMessage, CreateObjectMessageProcessor.class.getDeclaredField("_accessKeyType").getGenericType(), null, accessKey));
            } else {
                ...
                transformedAccessKey = ((String) evaluateAndTransform(_muleMessage, CreateObjectMessageProcessor.class.getDeclaredField("_accessKeyType").getGenericType(), null, castedModuleObject.getAccessKey()));
            }
            if (secretKey!= null) {
                transformedSecretKey = ((String) evaluateAndTransform(_muleMessage, CreateObjectMessageProcessor.class.getDeclaredField("_secretKeyType").getGenericType(), null, secretKey));
            } else {
                ...
                transformedSecretKey = ((String) evaluateAndTransform(_muleMessage, CreateObjectMessageProcessor.class.getDeclaredField("_secretKeyType").getGenericType(), null, castedModuleObject.getSecretKey()));
            }
            String transformedBucketName = ((String) evaluateAndTransform(_muleMessage, CreateObjectMessageProcessor.class.getDeclaredField("_bucketNameType").getGenericType(), null, bucketName));
            String transformedKey = ((String) evaluateAndTransform(_muleMessage, CreateObjectMessageProcessor.class.getDeclaredField("_keyType").getGenericType(), null, key));
            Object transformedContent = ((Object) evaluateAndTransform(_muleMessage, CreateObjectMessageProcessor.class.getDeclaredField("_contentType").getGenericType(), null, "#[payload]"));
            Long transformedContentLength = ((Long) evaluateAndTransform(_muleMessage, CreateObjectMessageProcessor.class.getDeclaredField("_contentLengthType").getGenericType(), null, contentLength));
            String transformedContentMd5 = ((String) evaluateAndTransform(_muleMessage, CreateObjectMessageProcessor.class.getDeclaredField("_contentMd5Type").getGenericType(), null, contentMd5));
            String transformedContentType = ((String) evaluateAndTransform(_muleMessage, CreateObjectMessageProcessor.class.getDeclaredField("_contentTypeType").getGenericType(), null, contentType));
            org.mule.module.s3.AccessControlList transformedAcl = ((org.mule.module.s3.AccessControlList) evaluateAndTransform(_muleMessage, CreateObjectMessageProcessor.class.getDeclaredField("_aclType").getGenericType(), null, acl));
            org.mule.module.s3.StorageClass transformedStorageClass = ((org.mule.module.s3.StorageClass) evaluateAndTransform(_muleMessage, CreateObjectMessageProcessor.class.getDeclaredField("_storageClassType").getGenericType(), null, storageClass));
            Map<String, String> transformedUserMetadata = ((Map<String, String> ) evaluateAndTransform(_muleMessage, CreateObjectMessageProcessor.class.getDeclaredField("_userMetadataType").getGenericType(), null, userMetadata));
