...
import org.mule.module.s3.config.GetBucketWebsiteConfigurationMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public GetBucketWebsiteConfigurationDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetBucketWebsiteConfigurationMessageProcessor.class.getName());
