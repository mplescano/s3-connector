...
import org.mule.module.s3.config.CreateObjectPresignedUriMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public CreateObjectPresignedUriDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(CreateObjectPresignedUriMessageProcessor.class.getName());
        ...
        if ((element.getAttribute("versionId")!= null)&&(!StringUtils.isBlank(element.getAttribute("versionId")))) {
            builder.addPropertyValue("versionId", element.getAttribute("versionId"));
        }
        if ((element.getAttribute("expiration")!= null)&&(!StringUtils.isBlank(element.getAttribute("expiration")))) {
            builder.addPropertyValue("expiration", element.getAttribute("expiration"));
        }
