...
import org.mule.module.s3.config.SetBucketPolicyMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public SetBucketPolicyDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(SetBucketPolicyMessageProcessor.class.getName());
        ...
        if ((element.getAttribute("policyText")!= null)&&(!StringUtils.isBlank(element.getAttribute("policyText")))) {
            builder.addPropertyValue("policyText", element.getAttribute("policyText"));
        }
