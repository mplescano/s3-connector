...
import org.mule.module.s3.config.GetBucketPolicyMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public GetBucketPolicyDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetBucketPolicyMessageProcessor.class.getName());
