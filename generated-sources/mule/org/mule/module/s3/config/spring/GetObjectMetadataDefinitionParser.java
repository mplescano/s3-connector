...
import org.mule.module.s3.config.GetObjectMetadataMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public GetObjectMetadataDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetObjectMetadataMessageProcessor.class.getName());
