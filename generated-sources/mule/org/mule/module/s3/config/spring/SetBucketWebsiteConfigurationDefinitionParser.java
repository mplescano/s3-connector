...
import org.mule.module.s3.config.SetBucketWebsiteConfigurationMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public SetBucketWebsiteConfigurationDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(SetBucketWebsiteConfigurationMessageProcessor.class.getName());
        ...
        if ((element.getAttribute("errorDocument")!= null)&&(!StringUtils.isBlank(element.getAttribute("errorDocument")))) {
            builder.addPropertyValue("errorDocument", element.getAttribute("errorDocument"));
        }
