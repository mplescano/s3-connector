...
import org.mule.module.s3.config.CreateBucketMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public CreateBucketDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(CreateBucketMessageProcessor.class.getName());
        ...
        if (element.hasAttribute("region")) {
            builder.addPropertyValue("region", element.getAttribute("region"));
        }
