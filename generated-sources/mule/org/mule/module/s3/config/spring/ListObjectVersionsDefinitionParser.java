...
import org.mule.module.s3.config.ListObjectVersionsMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public ListObjectVersionsDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(ListObjectVersionsMessageProcessor.class.getName());
