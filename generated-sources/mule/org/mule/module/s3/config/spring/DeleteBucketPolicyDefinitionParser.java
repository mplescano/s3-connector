...
import org.mule.module.s3.config.DeleteBucketPolicyMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public DeleteBucketPolicyDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(DeleteBucketPolicyMessageProcessor.class.getName());
