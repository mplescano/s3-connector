...
import org.mule.module.s3.config.ListObjectsMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public ListObjectsDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(ListObjectsMessageProcessor.class.getName());
        ...
        if ((element.getAttribute("prefix")!= null)&&(!StringUtils.isBlank(element.getAttribute("prefix")))) {
