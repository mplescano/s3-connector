...
import org.mule.module.s3.config.ListBucketsMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public ListBucketsDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(ListBucketsMessageProcessor.class.getName());
