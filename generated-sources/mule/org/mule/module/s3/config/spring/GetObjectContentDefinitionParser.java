...
import org.mule.module.s3.config.GetObjectContentMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public GetObjectContentDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetObjectContentMessageProcessor.class.getName());
