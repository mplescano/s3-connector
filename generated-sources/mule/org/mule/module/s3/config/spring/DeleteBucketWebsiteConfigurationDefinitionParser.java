...
import org.mule.module.s3.config.DeleteBucketWebsiteConfigurationMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public DeleteBucketWebsiteConfigurationDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(DeleteBucketWebsiteConfigurationMessageProcessor.class.getName());
