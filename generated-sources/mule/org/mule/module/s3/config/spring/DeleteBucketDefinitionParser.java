...
import org.mule.module.s3.config.DeleteBucketMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public DeleteBucketDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(DeleteBucketMessageProcessor.class.getName());
