...
import org.mule.module.s3.config.SetBucketVersioningStatusMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public SetBucketVersioningStatusDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(SetBucketVersioningStatusMessageProcessor.class.getName());
        ...
        if (element.hasAttribute("versioningStatus")) {
            builder.addPropertyValue("versioningStatus", element.getAttribute("versioningStatus"));
        }
