...
import org.mule.module.s3.config.CreateObjectUriMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public CreateObjectUriDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(CreateObjectUriMessageProcessor.class.getName());
        ...
        if ((element.getAttribute("useDefaultServer")!= null)&&(!StringUtils.isBlank(element.getAttribute("useDefaultServer")))) {
            builder.addPropertyValue("useDefaultServer", element.getAttribute("useDefaultServer"));
        }
