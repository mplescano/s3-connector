...
/**
 * CopyObjectMessageProcessor invokes the {@link org.mule.module.s3.S3Connector#copyObject(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, org.mule.module.s3.AccessControlList, org.mule.module.s3.StorageClass, java.util.Map, java.util.Date, java.util.Date)} method in {@link S3Connector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private String _sourceBucketNameType;
    private Object sourceKey;
    private String _sourceKeyType;
    private Object sourceVersionId;
    private String _sourceVersionIdType;
    private Object destinationBucketName;
    private String _destinationBucketNameType;
    private Object destinationKey;
    private String _destinationKeyType;
    private Object destinationAcl;
    private org.mule.module.s3.AccessControlList _destinationAclType;
    private Object destinationStorageClass;
    private org.mule.module.s3.StorageClass _destinationStorageClassType;
    private Object destinationUserMetadata;
    private Map<String, String> _destinationUserMetadataType;
    ...
    private static Logger logger = LoggerFactory.getLogger(CopyObjectMessageProcessor.class);
    /**
     * Module object
     * 
     */
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("copyObject"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
        ...
        try {
            if (accessKey!= null) {
                transformedAccessKey = ((String) evaluateAndTransform(_muleMessage, CopyObjectMessageProcessor.class.getDeclaredField("_accessKeyType").getGenericType(), null, accessKey));
            } else {
                if (castedModuleObject.getAccessKey() == null) {
                    throw new MessagingException(CoreMessages.failedToCreate("copyObject"), event, new RuntimeException("You must provide a accessKey at the config or the message processor level."));
                }
                transformedAccessKey = ((String) evaluateAndTransform(_muleMessage, CopyObjectMessageProcessor.class.getDeclaredField("_accessKeyType").getGenericType(), null, castedModuleObject.getAccessKey()));
            }
            if (secretKey!= null) {
                transformedSecretKey = ((String) evaluateAndTransform(_muleMessage, CopyObjectMessageProcessor.class.getDeclaredField("_secretKeyType").getGenericType(), null, secretKey));
            } else {
                if (castedModuleObject.getSecretKey() == null) {
                    throw new MessagingException(CoreMessages.failedToCreate("copyObject"), event, new RuntimeException("You must provide a secretKey at the config or the message processor level."));
                }
                transformedSecretKey = ((String) evaluateAndTransform(_muleMessage, CopyObjectMessageProcessor.class.getDeclaredField("_secretKeyType").getGenericType(), null, castedModuleObject.getSecretKey()));
            }
            String transformedSourceBucketName = ((String) evaluateAndTransform(_muleMessage, CopyObjectMessageProcessor.class.getDeclaredField("_sourceBucketNameType").getGenericType(), null, sourceBucketName));
            String transformedSourceKey = ((String) evaluateAndTransform(_muleMessage, CopyObjectMessageProcessor.class.getDeclaredField("_sourceKeyType").getGenericType(), null, sourceKey));
            String transformedSourceVersionId = ((String) evaluateAndTransform(_muleMessage, CopyObjectMessageProcessor.class.getDeclaredField("_sourceVersionIdType").getGenericType(), null, sourceVersionId));
            String transformedDestinationBucketName = ((String) evaluateAndTransform(_muleMessage, CopyObjectMessageProcessor.class.getDeclaredField("_destinationBucketNameType").getGenericType(), null, destinationBucketName));
            String transformedDestinationKey = ((String) evaluateAndTransform(_muleMessage, CopyObjectMessageProcessor.class.getDeclaredField("_destinationKeyType").getGenericType(), null, destinationKey));
            org.mule.module.s3.AccessControlList transformedDestinationAcl = ((org.mule.module.s3.AccessControlList) evaluateAndTransform(_muleMessage, CopyObjectMessageProcessor.class.getDeclaredField("_destinationAclType").getGenericType(), null, destinationAcl));
            org.mule.module.s3.StorageClass transformedDestinationStorageClass = ((org.mule.module.s3.StorageClass) evaluateAndTransform(_muleMessage, CopyObjectMessageProcessor.class.getDeclaredField("_destinationStorageClassType").getGenericType(), null, destinationStorageClass));
            Map<String, String> transformedDestinationUserMetadata = ((Map<String, String> ) evaluateAndTransform(_muleMessage, CopyObjectMessageProcessor.class.getDeclaredField("_destinationUserMetadataType").getGenericType(), null, destinationUserMetadata));
            Date transformedModifiedSince = ((Date) evaluateAndTransform(_muleMessage, CopyObjectMessageProcessor.class.getDeclaredField("_modifiedSinceType").getGenericType(), null, modifiedSince));
            Date transformedUnmodifiedSince = ((Date) evaluateAndTransform(_muleMessage, CopyObjectMessageProcessor.class.getDeclaredField("_unmodifiedSinceType").getGenericType(), null, unmodifiedSince));
            ...
            if (connection == null) {
                throw new MessagingException(CoreMessages.failedToCreate("copyObject"), event, new RuntimeException("Cannot create connection"));
            } else {
                if (logger.isDebugEnabled()) {
                    StringBuilder messageStringBuilder = new StringBuilder();
            ...
            resultPayload = connection.copyObject(transformedSourceBucketName, transformedSourceKey, transformedSourceVersionId, transformedDestinationBucketName, transformedDestinationKey, transformedDestinationAcl, transformedDestinationStorageClass, transformedDestinationUserMetadata, transformedModifiedSince, transformedUnmodifiedSince);
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("copyObject"), event, e);
        } finally {
            try {
                if (connection!= null) {
                    if (logger.isDebugEnabled()) {
