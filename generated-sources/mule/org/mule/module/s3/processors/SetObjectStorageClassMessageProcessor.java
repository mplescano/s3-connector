    ...
    implements MessageProcessor
{
    ...
    public SetObjectStorageClassMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        try {
            ...
            processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    ((S3Connector) object).setObjectStorageClass(_transformedBucketName, _transformedKey, _transformedStorageClass);
                    return null;
                }
